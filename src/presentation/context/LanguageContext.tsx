...
const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    mockNotice: 'Mode demostració actiu (NFC no disponible en aquest dispositiu)',
  ...
  es: {
    ...
    mockNotice: 'Modo demostración activo (NFC no disponible en este dispositivo)',
  ...
  en: {
    ...
    mockNotice: 'Demo mode active (NFC not available on this device)',
